"""
Django settings for variant project.
...
# For deployment security settings, see:
...
CSRF_TRUSTED_ORIGINS = [ 'variant.ms', '.variant.ms' ]
...
INSTALLED_APPS = [
    'variant_app.apps.VariantAppConfig',
#    'silk',
